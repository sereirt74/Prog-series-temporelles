...
namespace RegArchLib {
	...
	*/
	...
	void cGedResiduals::ComputeHess(uint theDate, const cRegArchValue& theData, const cRegArchGradient& theGradData, cRegArchHessien& theHessData)
	{
	...
	void cGedResiduals::ComputeGradAndHess(uint theDate, const cRegArchValue& theData, cRegArchGradient& theGradData, cRegArchHessien& theHessData)
	{
		double myX = theData.mEpst[theDate];
		cDVector myGradDiffLogDens = cDVector(1);
		GradDiffLogDensity(myX, *mDistrParameter, myGradDiffLogDens);
