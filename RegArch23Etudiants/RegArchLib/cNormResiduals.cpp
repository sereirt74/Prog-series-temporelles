...
cAbstResiduals* cNormResiduals::PtrCopy() const
	{
		return cAbstResidualsPtrCopy<cNormResiduals>();
	}
*/
	/*!
	...
	*/
	...
	void cNormResiduals::ComputeHessBetaEspAbsEps(cDMatrix &theHess)
	{
	}
	...
	void cNormResiduals::ComputeHess(uint theDate, const cRegArchValue& theData, const cRegArchGradient& theGradData, cRegArchHessien& theHessData)
	{

	}

	void cNormResiduals::ComputeGradAndHess(uint theDate, const cRegArchValue& theData, cRegArchGradient& theGradData, cRegArchHessien& theHessData)
	{
	...
	void cNormResiduals::GetParamName(uint theIndex, string theName[])
	{
	}
