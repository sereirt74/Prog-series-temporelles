...
*/
	...
	uint cConstCondVar::GetNu(void) const
	{
		return 0;
	}
	uint cConstCondVar::GetNh(void) const
	{
		return 0;
	}
	...
	void  cConstCondVar::ComputeGradForM(uint theDate, const cRegArchValue& theValue, int theBegIndex, cFuncMeanAndVar& theDerivM, cAbstResiduals* theResids)
	{
		theDerivM.mdFx[theBegIndex] = 1.0;
	}
	...
	void cConstCondVar::ComputeHessForM(uint theDate, const cRegArchValue& theValue, uint theBegIndex, cFuncMeanAndVar& theDerivM, cAbstResiduals* theResids)
	{
		theDerivM.md2Fxx[theBegIndex][theBegIndex] = 0.0;
	}
	...
	void cConstCondVar::GetParamName(uint theIndex, string theName[])
	{
	uint myIndex = theIndex;
	char myChar[100];
