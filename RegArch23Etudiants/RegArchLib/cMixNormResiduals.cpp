...
*/
	...
	void cMixNormResiduals::ComputeHess(uint theDate, const cRegArchValue& theData, const cRegArchGradient& theGradData, cRegArchHessien& theHessData)
	{
	...
	void cMixNormResiduals::ComputeGradAndHess(uint theDate, const cRegArchValue& theData, cRegArchGradient& theGradData, cRegArchHessien& theHessData)
	{
		double myX = theData.mEpst[theDate];
		cDVector myGradDiffLogDens = cDVector(3);
		GradDiffLogDensity(myX, *mDistrParameter, myGradDiffLogDens);
