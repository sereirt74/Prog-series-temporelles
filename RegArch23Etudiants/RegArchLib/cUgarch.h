...
/*!
	\file cUgarch.h
	\brief Definition of the UGARCH(p, q) class
...
// h(t) = sigma(t)^2 = [Const] + Xv(t) beta + sum_{i=1}{p}{Arch[i]*U(t-i)^2} + sum_{j=1}^{q}{Garch[j]*h(t-j)}
// Xv(t) regressor values à time t, beta vector of regressor parameters
//
...
namespace RegArchLib {
	...
	public :
		...
		cUgarch(const cUgarch& theUgarch);
